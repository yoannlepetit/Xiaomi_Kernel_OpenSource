...
static inline unsigned int upmu_get_rgs_vcdt_hv_det(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHR_CON0),
				  (&val),
...
static inline void upmu_set_rg_chr_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcdt_hv_vth(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON1),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rgs_vbat_cc_det(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHR_CON2),
				  (&val),
...
static inline void upmu_set_rg_cs_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vbat_cc_vth(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_cs_vth(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pchr_toltc(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON5),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rgs_vbat_ov_det(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHR_CON6),
				  (&val),
...
static inline void upmu_set_rg_vbat_ov_deg(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rgs_baton_undet(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHR_CON7),
				  (&val),
...
static inline void upmu_set_rg_baton_ht_trim_set(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_csdac_data(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_frc_csvth_usbdl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON9),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rgs_otg_bvalid_det(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHR_CON10),
				  (&val),
...
static inline void upmu_set_rg_otg_bvalid_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pchr_flag_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON11),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pchr_ft_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON12),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_chrwdt_wr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON13),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pchr_rv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rgs_chrwdt_out(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHR_CON15),
				  (&val),
...
static inline void upmu_set_rg_chrwdt_flag_wr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON15),
				    (unsigned int) (val),
...
static inline void upmu_set_adcin_vchr_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON16),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_bgr_unchop(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON17),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rgs_bc11_cmp_out(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHR_CON18),
				  (&val),
...
static inline void upmu_set_rg_bc11_vsrc_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_bc11_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON19),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_csdac_stp_dec(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON20),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_csdac_stp(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON21),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_chrind_dimming(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON22),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_ulc_det_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON23),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_ichrg_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON24),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_bgr_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON25),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_ovp_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON26),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_bgr_test_rstb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON27),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dac_usbdl_max(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON28),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pchr_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHR_CON29),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_cid(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CID),
...
static inline void upmu_set_rg_strup_6m_pdn(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKPDN),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_top_ckpdn2_rsv_15(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKPDN2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_top_gpio_ckpdn_rsv_15_14(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_GPIO_CKPDN),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_top_rst_con_rsv_15_9(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_RST_CON),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_wrp_pdn(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (WRP_CKPDN),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_wrp_rst(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (WRP_RST_CON),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pwrkey_rst_td(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_RST_MISC),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_osc_sel_align_dis(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKCON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_fqmtr_cksel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKCON2),
				    (unsigned int) (val),
...
static inline void upmu_set_auxadc_tstsel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKTST1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_top_cktst2_rsv_15_10(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKTST2),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_deg_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (OC_DEG_EN),
				    (unsigned int) (val),
...
static inline void upmu_set_oc_gear_bvalid_det(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (OC_CTL0),
				    (unsigned int) (val),
...
static inline void upmu_set_vgpu_oc_wnd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (OC_CTL1),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_oc_wnd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (OC_CTL2),
				    (unsigned int) (val),
...
static inline void upmu_set_int_rsv_15_8(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (INT_RSV),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_mon_grp_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TEST_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_test_spk_pwm(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TEST_CON1),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_vrtc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (STATUS0),
				  (&val),
...
static inline unsigned int upmu_get_status_va28_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (STATUS1),
				  (&val),
...
static inline unsigned int upmu_get_vsrmca15_pg_deb(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (PGSTATUS),
				  (&val),
...
static inline void upmu_set_rtc_xtal_det_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (CHRSTATUS),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rtc_xtal_det_done(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (CHRSTATUS),
				  (&val),
...
static inline unsigned int upmu_get_oc_status_vtcxo(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (OCSTATUS0),
				  (&val),
...
static inline unsigned int upmu_get_oc_status_va28(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (OCSTATUS1),
				  (&val),
...
static inline unsigned int upmu_get_homekey_deb(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (OCSTATUS2),
				  (&val),
...
static inline void upmu_set_rg_top_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (HDMI_PAD_IE),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_test_out_l(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (TEST_OUT_L),
				  (&val),
...
static inline unsigned int upmu_get_test_out_h(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (TEST_OUT_H),
				  (&val),
...
static inline void upmu_set_rg_hdmi_tdsel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TDSEL_CON),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_hdmi_rdsel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RDSEL_CON),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_smt15(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (GPIO_SMT_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_smt31(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (GPIO_SMT_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_smt47(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (GPIO_SMT_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_homekey_pden(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (GPIO_SMT_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_srclken_peri(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_spi_clk(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_spi_miso(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_aud_mosi(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_col2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_col6(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_row2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_row6(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_pwm(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_sda1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_sda2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_cec(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON11),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_octl_simls2_srst(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DRV_CON12),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_int_en_ov(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (INT_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_int_en_vdrm(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (INT_CON1),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_int_status_ov(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (INT_STATUS0),
				  (&val),
...
static inline unsigned int upmu_get_rg_int_status_vdrm(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (INT_STATUS1),
				  (&val),
...
static inline void upmu_set_fqmtr_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FQMTR_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_fqmtr_busy(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FQMTR_CON0),
				  (&val),
...
static inline void upmu_set_fqmtr_winset(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FQMTR_CON1),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_fqmtr_data(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FQMTR_CON2),
				  (&val),
...
static inline void upmu_set_rg_efuse_addr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_prog(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_pkey(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_rd_trig(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_rd_rdy_bypass(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_CON5),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_efuse_busy(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_CON6),
				  (&val),
...
static inline void upmu_set_rg_efuse_val_0_15(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_0_15),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_16_31(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_16_31),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_32_47(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_32_47),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_48_63(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_48_63),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_64_79(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_64_79),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_80_95(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_80_95),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_96_111(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_96_111),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_112_127(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_112_127),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_128_143(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_128_143),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_144_159(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_144_159),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_160_175(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_160_175),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_176_191(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_176_191),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_192_207(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_192_207),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_208_223(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_208_223),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_224_239(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_224_239),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_240_255(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_240_255),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_256_271(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_256_271),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_272_287(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_272_287),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_288_303(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_288_303),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_efuse_val_304_319(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (EFUSE_VAL_304_319),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_efuse_dout_0_15(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_0_15),
				  (&val),
...
static inline unsigned int upmu_get_rg_efuse_dout_16_31(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_16_31),
				  (&val),
...
static inline unsigned int upmu_get_rg_efuse_dout_32_47(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_32_47),
				  (&val),
...
static inline unsigned int upmu_get_rg_efuse_dout_48_63(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_48_63),
				  (&val),
...
static inline void upmu_set_spi_con(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPI_CON),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_auxadc_div_ck_pdn(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKPDN3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_wrap_event_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (TOP_CKCON3),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_efuse_dout_64_79(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_64_79),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_80_95(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_80_95),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_96_111(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_96_111),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_112_127(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_112_127),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_128_143(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_128_143),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_144_159(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_144_159),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_160_175(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_160_175),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_176_191(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_176_191),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_192_207(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_192_207),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_208_223(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_208_223),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_224_239(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_224_239),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_240_255(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_240_255),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_256_271(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_256_271),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_272_287(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_272_287),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_288_303(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_288_303),
				  (&val),
...
static inline unsigned int upmu_get_efuse_dout_304_319(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (EFUSE_DOUT_304_319),
				  (&val),
...
static inline void upmu_set_rg_smps_testmode_b(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca7_dig_mon(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (BUCK_CON1),
				  (&val),
...
static inline unsigned int upmu_get_qi_vcore_dig_mon(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (BUCK_CON2),
				  (&val),
...
static inline void upmu_set_buck_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vpca7_trimh(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca7_trimh(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcore_trimh(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vdrm_trimh(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_qi_vcore_vsleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_qi_vdrm_vsleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vca15_zxos_trim2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vca15_csl2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vca15_ndis_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vca15_csm2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vca15_rsv1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vca15_track_on_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vca15_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vca15_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON7),
				  (&val),
...
static inline void upmu_set_vca15_stbtd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vca15_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vca15_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vca15_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vca15_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vca15_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vca15_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON13),
				  (&val),
...
static inline void upmu_set_vca15_burst_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vca15_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON14),
				  (&val),
...
static inline void upmu_set_vca15_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vca15_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON15),
				  (&val),
...
static inline void upmu_set_vca15_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vca15_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON16),
				  (&val),
...
static inline unsigned int upmu_get_qi_vca15_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON17),
				  (&val),
...
static inline unsigned int upmu_get_ni_vca15_vsleep_sel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCA15_CON18),
				  (&val),
...
static inline void upmu_set_vca15_vsleep_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCA15_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca15_zxos_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca15_zx_os(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca15_ndis_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON2),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca15_slpo_out(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON3),
				  (&val),
...
static inline void upmu_set_vsrmca15_sawcal_td(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca15_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_track_sleep_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca15_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON7),
				  (&val),
...
static inline void upmu_set_vsrmca15_stbtd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vsrmca15_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vsrmca15_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON13),
				  (&val),
...
static inline void upmu_set_vsrmca15_burst_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca15_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON14),
				  (&val),
...
static inline void upmu_set_vsrmca15_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca15_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON15),
				  (&val),
...
static inline void upmu_set_vsrmca15_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca15_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON16),
				  (&val),
...
static inline unsigned int upmu_get_qi_vsrmca15_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON17),
				  (&val),
...
static inline unsigned int upmu_get_ni_vsrmca15_vsleep_sel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA15_CON18),
				  (&val),
...
static inline void upmu_set_vsrmca15_vsleep_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_vosel_offset(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON19),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_vosel_on_hb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON20),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_vosel_sleep_lb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA15_CON21),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcore_zxos_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcore_zx_os(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcore_ndis_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcore_slp(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcore_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vcore_burst_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vcore_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vcore_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON7),
				  (&val),
...
static inline void upmu_set_vcore_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vcore_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vcore_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vcore_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vcore_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vcore_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vcore_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON13),
				  (&val),
...
static inline void upmu_set_vcore_burst_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vcore_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON14),
				  (&val),
...
static inline void upmu_set_vcore_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vcore_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON15),
				  (&val),
...
static inline void upmu_set_vcore_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vcore_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON16),
				  (&val),
...
static inline unsigned int upmu_get_qi_vcore_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON17),
				  (&val),
...
static inline unsigned int upmu_get_ni_vcore_vsleep_sel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VCORE_CON18),
				  (&val),
...
static inline void upmu_set_vcore_vsleep_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VCORE_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgpu_zxos_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgpu_zx_os(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgpu_ndis_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgpu_slp(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgpu_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vgpu_burst_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vgpu_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgpu_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON7),
				  (&val),
...
static inline void upmu_set_vgpu_stbtd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vgpu_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vgpu_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vgpu_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vgpu_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vgpu_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vgpu_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON13),
				  (&val),
...
static inline void upmu_set_vgpu_burst_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgpu_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON14),
				  (&val),
...
static inline void upmu_set_vgpu_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgpu_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON15),
				  (&val),
...
static inline void upmu_set_vgpu_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgpu_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON16),
				  (&val),
...
static inline unsigned int upmu_get_qi_vgpu_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON17),
				  (&val),
...
static inline unsigned int upmu_get_ni_vgpu_vsleep_sel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VGPU_CON18),
				  (&val),
...
static inline void upmu_set_vgpu_vsleep_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VGPU_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vio18_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vio18_zx_os(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vio18_csmir(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vio18_slp(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vio18_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vio18_burst_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vio18_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vio18_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON7),
				  (&val),
...
static inline void upmu_set_vio18_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vio18_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vio18_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vio18_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vio18_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vio18_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vio18_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON13),
				  (&val),
...
static inline unsigned int upmu_get_qi_vio18_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON14),
				  (&val),
...
static inline void upmu_set_vio18_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vio18_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON15),
				  (&val),
...
static inline void upmu_set_vio18_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vio18_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON16),
				  (&val),
...
static inline void upmu_set_vio18_bursth_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON16),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vio18_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON17),
				  (&val),
...
static inline void upmu_set_vio18_burstl_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON17),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vio18_sleep_pdn(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VIO18_CON18),
				  (&val),
...
static inline void upmu_set_vio18_sleep_pdn(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VIO18_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vpca7_zxos_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vpca7_zx_os(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vpca7_ndis_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON2),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vpca7_slpo_out(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON3),
				  (&val),
...
static inline void upmu_set_vpca7_sawcal_td(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vpca7_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vpca7_track_on_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vpca7_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vpca7_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON7),
				  (&val),
...
static inline void upmu_set_vpca7_stbtd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vpca7_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vpca7_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vpca7_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vpca7_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vpca7_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vpca7_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON13),
				  (&val),
...
static inline void upmu_set_vpca7_burst_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vpca7_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON14),
				  (&val),
...
static inline void upmu_set_vpca7_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vpca7_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON15),
				  (&val),
...
static inline void upmu_set_vpca7_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vpca7_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON16),
				  (&val),
...
static inline unsigned int upmu_get_qi_vpca7_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON17),
				  (&val),
...
static inline unsigned int upmu_get_ni_vpca7_vsleep_sel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VPCA7_CON18),
				  (&val),
...
static inline void upmu_set_vpca7_vsleep_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VPCA7_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca7_zxos_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca7_zx_os(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca7_ndis_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON2),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca7_slpo_out(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON3),
				  (&val),
...
static inline void upmu_set_vsrmca7_sawcal_td(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vsrmca7_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_track_sleep_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca7_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON7),
				  (&val),
...
static inline void upmu_set_vsrmca7_stbtd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vsrmca7_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vsrmca7_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON13),
				  (&val),
...
static inline void upmu_set_vsrmca7_burst_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca7_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON14),
				  (&val),
...
static inline void upmu_set_vsrmca7_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca7_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON15),
				  (&val),
...
static inline void upmu_set_vsrmca7_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vsrmca7_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON16),
				  (&val),
...
static inline unsigned int upmu_get_qi_vsrmca7_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON17),
				  (&val),
...
static inline unsigned int upmu_get_ni_vsrmca7_vsleep_sel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VSRMCA7_CON18),
				  (&val),
...
static inline void upmu_set_vsrmca7_vsleep_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_vosel_offset(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON19),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_vosel_on_hb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON20),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca7_vosel_sleep_lb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VSRMCA7_CON21),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vdrm_zxos_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vdrm_zx_os(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vdrm_ndis_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vdrm_slp(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vdrm_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_burst_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_burst_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vdrm_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON7),
				  (&val),
...
static inline void upmu_set_vdrm_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_sfchg_ren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_vosel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_vosel_on(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_vdrm_vosel_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_ni_vdrm_vosel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON12),
				  (&val),
...
static inline unsigned int upmu_get_qi_vdrm_burst(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON13),
				  (&val),
...
static inline void upmu_set_vdrm_burst_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vdrm_dlc(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON14),
				  (&val),
...
static inline void upmu_set_vdrm_dlc_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON14),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vdrm_dlc_n(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON15),
				  (&val),
...
static inline void upmu_set_vdrm_dlc_n_sleep(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON15),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vdrm_bursth(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON16),
				  (&val),
...
static inline unsigned int upmu_get_qi_vdrm_burstl(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON17),
				  (&val),
...
static inline unsigned int upmu_get_ni_vdrm_vsleep_sel(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (VDRM_CON18),
				  (&val),
...
static inline void upmu_set_vdrm_vsleep_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (VDRM_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_k_control_smps(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (BUCK_K_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_smps_osc_cal(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (BUCK_K_CON1),
				  (&val),
...
static inline unsigned int upmu_get_qi_vtcxo_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (ANALDO_CON0),
				  (&val),
...
static inline void upmu_set_vtcxo_srclk_en_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_va28_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (ANALDO_CON1),
				  (&val),
...
static inline void upmu_set_rg_va28_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcama_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON2),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vtcxo_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (ANALDO_CON3),
				  (&val),
...
static inline void upmu_set_rg_va28_bist_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vtcxo_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_va28_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vcama_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_aldo_reserve_1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ANALDO_CON7),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vio28_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON0),
				  (&val),
...
static inline void upmu_set_vio28_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vusb_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON1),
				  (&val),
...
static inline void upmu_set_rg_vusb_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON1),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vmc_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON2),
...
static inline void upmu_set_rg_vmc_int_dis_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON2),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vmch_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON3),
				  (&val),
...
static inline void upmu_set_rg_vmch_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON3),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vemc_3v3_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON4),
				  (&val),
...
static inline void upmu_set_rg_vemc_3v3_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgp1_sw_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON5),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgp1_mode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON5),
				  (&val),
...
static inline void upmu_set_rg_vgp2_sw_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgp2_mode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON6),
				  (&val),
...
static inline void upmu_set_rg_vgp3_sw_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON7),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgp3_mode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON7),
				  (&val),
...
static inline void upmu_set_rg_vgp4_sw_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON8),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgp4_mode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON8),
				  (&val),
...
static inline void upmu_set_rg_vgp5_sw_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON9),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgp5_mode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON9),
				  (&val),
...
static inline void upmu_set_rg_vgp6_sw_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON10),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vgp6_mode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON10),
				  (&val),
...
static inline void upmu_set_rg_vibr_mid_state(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vrtc_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON12),
				  (&val),
...
static inline void upmu_set_vrtc_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON12),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vio28_bist_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vio28_oc_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON14),
				  (&val),
...
static inline void upmu_set_rg_vio28_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON15),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vusb_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON16),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vmch_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON17),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vemc_3v3_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgp1_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON19),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgp2_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON20),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgp3_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON21),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgp4_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON22),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgp5_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON23),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vibr_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON24),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_vibr_mode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (DIGLDO_CON24),
				  (&val),
...
static inline void upmu_set_rg_vibr_vocal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON25),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vrtc_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON26),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_ldo_ft(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON27),
				    (unsigned int) (val),
...
static inline void upmu_set_vgp1_srclk_en_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON28),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vmc_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON29),
				    (unsigned int) (val),
...
static inline void upmu_set_vgp1_on_ctrl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON30),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_stb_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON31),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_rsv_stb_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON32),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vgp6_cal(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (DIGLDO_CON33),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_thrdet_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vref_bg(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pmu_lev_ungate(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON3),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_pmu_thr_status(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (STRUP_CON4),
				  (&val),
...
static inline void upmu_set_thr_test(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_strup_dig_io28_pg_force(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_vsrmca15_pg_enb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_qi_osc_en(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (STRUP_CON7),
...
static inline void upmu_set_vsrmca15_pg_h2l_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_strup_con8_rsv0(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_strup_auxadc_rstb_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_strup_pwroff_preoff_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (STRUP_CON10),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c0(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC0),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c1(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC1),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c2(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC2),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c3(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC3),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c4(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC4),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c5(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC5),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c6(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC6),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_c7(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC7),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_wakeup_pchr(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC8),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_wakeup_swchr(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC9),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_rdy_lbat(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC10),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c0_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC11),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c1_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC12),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c2_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC13),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c3_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC14),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c4_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC15),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c5_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC16),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c6_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC17),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_c7_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC18),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_wakeup_pchr_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC19),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_wakeup_swchr_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC20),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_lbat_trim(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC21),
				  (&val),
...
static inline unsigned int upmu_get_rg_adc_out_avg_deci(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_ADC22),
				  (&val),
...
static inline void upmu_set_rg_spl_num(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_auxadc_chsel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_lbat_debt_min(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_lbat_det_prd_15_0(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_lbat_det_prd_19_16(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON4),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_lbat_max_irq_b(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_CON5),
				  (&val),
...
static inline void upmu_set_rg_lbat_en_max(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON5),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_lbat_min_irq_b(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_CON6),
				  (&val),
...
static inline void upmu_set_rg_lbat_en_min(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON6),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_lbat_debounce_count_max(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_CON7),
				  (&val),
...
static inline unsigned int upmu_get_rg_lbat_debounce_count_min(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_CON8),
				  (&val),
...
static inline unsigned int upmu_get_rg_ni_comp(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (AUXADC_CON9),
				  (&val),
...
static inline void upmu_set_rg_da_dac(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_auxadc_cali(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_efuse_offset_ch0_trim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON11),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_vbuf_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON12),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_thermal_adc_oe(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON13),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_adc_trim_ch_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUXADC_CON14),
				    (unsigned int) (val),
...
static inline void upmu_set_flash_rsv0(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FLASH_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_flash_dim_div(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FLASH_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_flash_sfstren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FLASH_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_kpled_rsv0(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (KPLED_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_kpled_dim_div(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (KPLED_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_kpled_sfstren(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (KPLED_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_isink_rsv0(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_isink_rsv1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_isink_rsv2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_isink_rsv3(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_isinks_ch0_step(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_isinks_ch1_step(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_isinks_ch2_step(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_trim_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_isinks_breath0_trf_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_isinks_breath1_trf_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_isinks_breath2_trf_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_isink0_sfstr_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ISINKS_CON11),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audaccdetrsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_seq_init(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_mbias_pwm_idle(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_pwm_width(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_pwm_thresh(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_fall_delay(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_debounce0(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_debounce1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_debounce2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_debounce3(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_ival_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_irq_clr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON11),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_accdet_irq(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (ACCDET_CON11),
				  (&val),
...
static inline void upmu_set_accdet_pwm_en_sw(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON12),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_accdet_cmp_clk(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (ACCDET_CON13),
				  (&val),
...
static inline unsigned int upmu_get_accdet_cur_deb(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (ACCDET_CON14),
				  (&val),
...
static inline void upmu_set_accdet_rsv_con0(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON15),
				    (unsigned int) (val),
...
static inline void upmu_set_accdet_rsv_con1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ACCDET_CON16),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_spk_gainl(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_spk_trim_done_l(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (SPK_CON1),
				  (&val),
...
static inline void upmu_set_spk_offset_l_mode(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_spk_oc_en_l(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_spk_gainr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON3),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_spk_trim_done_r(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (SPK_CON4),
				  (&val),
...
static inline void upmu_set_spk_offset_r_mode(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_spkpga_gainr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON5),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_spk_ab_oc_l_deg(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (SPK_CON6),
				  (&val),
...
static inline void upmu_set_spk_oc_thd(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_spk_trim_div(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON7),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_spk_octh_d(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON8),
				    (unsigned int) (val),
...
static inline void upmu_set_spk_test_mode1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON9),
				    (unsigned int) (val),
...
static inline void upmu_set_spk_td_done(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON10),
				    (unsigned int) (val),
...
static inline void upmu_set_spk_trim_stop_l_sw(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (SPK_CON11),
				    (unsigned int) (val),
...
static inline void upmu_set_fg_sw_rstclr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_fg_latchdata_st(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON0),
				  (&val),
...
static inline unsigned int upmu_get_fg_car_35_32(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON1),
				  (&val),
...
static inline unsigned int upmu_get_fg_car_31_16(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON2),
				  (&val),
...
static inline unsigned int upmu_get_fg_car_15_00(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON3),
				  (&val),
...
static inline unsigned int upmu_get_fg_nter_29_16(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON4),
				  (&val),
...
static inline unsigned int upmu_get_fg_nter_15_00(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON5),
				  (&val),
...
static inline void upmu_set_fg_bltr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_fg_bftr(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON7),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_fg_current_out(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON8),
				  (&val),
...
static inline void upmu_set_fg_adjust_offset_value(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON9),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_fg_offset(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON10),
...
static inline void upmu_set_rg_inputclksel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON11),
				    (unsigned int) (val),
...
static inline void upmu_set_fg_adc_autorst(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON12),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_fgvmode(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON13),
				  (&val),
...
static inline void upmu_set_fg_slp_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON13),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_vol_current_out(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON14),
				  (&val),
...
static inline unsigned int upmu_get_fg_cic2(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (FGADC_CON15),
...
static inline void upmu_set_fg_slp_cur_th(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON16),
				    (unsigned int) (val),
...
static inline void upmu_set_fg_slp_time(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON17),
				    (unsigned int) (val),
...
static inline void upmu_set_fg_det_time(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON18),
				    (unsigned int) (val),
...
static inline void upmu_set_fg_test_mode1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (FGADC_CON19),
				    (unsigned int) (val),
...
static inline void upmu_set_stmp_mode(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RTC_MIX_CON0),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_mix_xosc32_stp_lpdtb(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (RTC_MIX_CON0),
				  (&val),
...
static inline void upmu_set_mix_efuse_xosc32_enb_opt(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RTC_MIX_CON1),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_mix_rtc_xosc32_enb(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (RTC_MIX_CON1),
				  (&val),
...
static inline void upmu_set_rg_dc2ac_en_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDDAC_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audhprscdisable_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDBUF_CFG0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_linenoiseenh_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDBUF_CFG1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_hsout_shortvcm_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDBUF_CFG2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_line_pull0v_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDBUF_CFG3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_abidec_reserved_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDBUF_CFG4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audibiaspwrdn_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (IBIASDIST_CFG0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_chargeoption_depop_va28(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDACCDEPOP_CFG0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audivrmute_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUD_IV_CFG0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_sel_delay_vcore(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDCLKGEN_CFG0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_va28refgen_en_va28(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDLDO_CFG0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audpmu_reserved_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDLDO_CFG1),
				    (unsigned int) (val),
...
static inline void upmu_set_da_nvreg_en_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDNVREGGLB_CFG0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_ncp_remote_sense_va18(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUD_NCP0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audpreampiddtest(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDPREAMP_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audadc3rdstagereset(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDADC_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audrctunelsel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDADC_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audadcdacfbcurrent(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDADC_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audadctestdata(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDADC_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audadcdacnrz(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDADC_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audspareva18(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDADC_CON5),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audsparevaudp(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDADC_CON6),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audmicbiasvref(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDDIGMI_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audlsbufrmute(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDLSBUF_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audlsbuf2iddtest(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDLSBUF_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audencspareva18(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDENCSPARE_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_clksq_monen_va28(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDENCCLKSQ_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audenc_reserved(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (AUDPREAMPGAIN_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audzcdmuxsel_vaudp12(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ZCD_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audlinegain(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ZCD_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audhprgain(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ZCD_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audhsgain(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ZCD_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_audivrgain(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (ZCD_CON4),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rg_audintgain2(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (ZCD_CON5),
				  (&val),
...
static inline void upmu_set_rg_divcks_chg(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (NCP_CLKDIV_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_pwd_ncp(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (NCP_CLKDIV_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_loadc2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_TMP1_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_tmp1_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_TMP1_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_tmp2_c2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_TMP2_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_tmp2_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_TMP2_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_tmp3_c2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_TMP3_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_tmp3_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_TMP3_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_final_c2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_FINAL_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_final_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_FINAL_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_loadc2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_rsv(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_TMP1_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_tmp1_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_TMP1_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_tmp2_c2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_TMP2_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_tmp2_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_TMP2_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_tmp3_c2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_TMP3_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_tmp3_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_TMP3_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_final_c2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_FINAL_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_final_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_FINAL_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_ldo_rf2_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_c2(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_tmp1_tielow_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_TMP1_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_tmp1_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_TMP1_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_tmp2_tielow_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_TMP2_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_tmp2_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_TMP2_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_tmp3_tielow_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_TMP3_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_tmp3_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_TMP3_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_final_tielow_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_FINAL_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_final_fpmbuf_bias_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_FINAL_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_ldo_buftop_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_icont(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_c2_untrim(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_ldo_fpm_rctb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_manual_ldo_rf2_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_MANUAL_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_manual_ldo_fpm_rctb(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_MANUAL_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_manual_ldo_buftop_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_MANUAL_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_ldo_rf1_v(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_ANALOG_CON0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_test_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_ANALOG_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_test_sel(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_ANALOG_CON2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_float_cap(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_ANALOG_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_reserved1(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_ANALOG_CON4),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_ft_trim_option(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_FORCE_MODE0),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_ck_chg_delay(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_FORCE_MODE1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_32k_residual(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_FORCE_MODE2),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_s2a_ldo_buftop_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_S2A_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_a2s_ldo_buftop_en(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_A2S_CON1),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_por2_cap_low(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_POR2_CON3),
				    (unsigned int) (val),
...
static inline void upmu_set_rg_dcxo_ft_trim_length_option(unsigned int val)
{
	...
	pmic_lock();
	pmic_config_interface((unsigned int) (RG_DCXO_FORCE_MODE3),
				    (unsigned int) (val),
...
static inline unsigned int upmu_get_rgs_dcxo_c2(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (RG_DCXO_ANALOG_RO0),
				  (&val),
...
static inline unsigned int upmu_get_rgs_dcxo_trim2_c2(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (RG_DCXO_TRIM_RO0),
				  (&val),
...
static inline unsigned int upmu_get_rgs_dcxo_ft_freq_trim_step_value(void)
{
	...
	pmic_lock();
	pmic_read_interface((unsigned int) (RG_DCXO_TRIM_RO1),
				  (&val),
